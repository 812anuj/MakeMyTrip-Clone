...
const Footer = () => {
  ...
  <div className="flex flex-col md:flex-row justify-between items-center">
    <div className="flex space-x-6 mb-4 md:mb-0">
      <a href="https://www.instagram.com/anujmendhe_?utm_source=qr&igsh=NHQ3eHRoYzBsbTBi" className="hover:text-white">
        <Instagram className="w-5 h-5" />
      </a>
      <a href="https://www.instagram.com/anujmendhe_?utm_source=qr&igsh=NHQ3eHRoYzBsbTBi" className="hover:text-white">
        <Twitter className="w-5 h-5" />
      </a>
      <a href="https://www.linkedin.com/in/anuj-mendhe-005673325/" target="_blank" rel="noopener noreferrer" className="hover:text-white">
    ...
    <div className="text-center text-sm">
      <p>© 2024 MakeMyTour PVT. LTD. All rights reserved</p>
      <p className="mt-1 text-gray-400">
        Built by 
        <a
          href="https://www.linkedin.com/in/anuj-mendhe-005673325/"
          target="_blank"
